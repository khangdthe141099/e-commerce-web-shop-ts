...
export const DetailsInfo = styled.div`
    ...
    opacity: ${(props: {toggle: boolean}) => props.toggle === true ? 1 : 0};
`
...
export const IconItem = styled.div`
    border-right: ${(props: { flag?: string }) => props.flag === 'right' ? '' : '1px solid rgb(229, 232, 235)'};
    border-bottom: 1px solid rgb(229, 232, 235);
    border-left: ${(props: { flag?: string }) => props.flag === 'left' ? '' : '1px solid rgb(229, 232, 235)'};
